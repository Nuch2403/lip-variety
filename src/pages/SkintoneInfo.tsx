...
const SKINTONE = [
  { code: "fair",         label: "ผิวขาวซีด",    img: imgPale,  desc: "ผิวหนังมีสีซีดหรือใส คุณจะแพ้แดดได้ง่ายมาก ผิวมักจะมีรอยตกกระหรือมีรอยแดง" },
  { code: "light_yellow", label: "ผิวขาวเหลือง", img: imgFair,  desc: "ผิวที่พบบ่อยในเอเชีย โทนออกเหลืองนิด ๆ เวลาที่ตากแดด ผิวจะไหม้และอาจเป็นสีแทน" },
  { code: "medium",       label: "ผิวสองสี",      img: imgOlive, desc: "ผิวมักจะไม่ค่อยไหม้แดดหรือแพ้อะไรง่ายนัก บาลานซ์ระหว่างสว่างและแทน" },
  { code: "tan",          label: "ผิวแทน",        img: imgTan,   desc: "ผิวจะเป็นสีแทนหรือสีน้ำผึ้ง ผิวจะไหม้แดดยากและผิวยังดูออกสีแทนแม้ในหน้าหนาว" },
  { code: "deep",         label: "ผิวเข้ม",       img: imgDark,  desc: "ผิวสีเข้มและจะไม่มีทางเกิดอาการผิวไหม้แดด" },
];
