...
const OPTIONS = [
  ...
  { code: "light_yellow", label: "ผิวขาวเหลือง", image: yellowSkin,  desc: "ผิวขาวโทนเหลืองหรือเอเชีย ดูสว่างแต่ไม่ซีด" },
  ...
  { code: "deep",         label: "ผิวเข้ม",       image: deepSkin,    desc: "ผิวสีน้ำตาลเข้มหรือช็อกโกแลต โทนลึก ชัด" },
];
