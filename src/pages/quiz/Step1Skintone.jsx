...
// Local assets for each skintone option
...
const OPTIONS = [
  {
    ...
    label: "ผิวขาวซีด",
    image: paleSkin,
    desc: "ผิวขาวมาก โทนชมพูหรือซีด เห็นเส้นเลือดใต้ผิวค่อนข้างชัด"
  },
  {
    code: "light_yellow",
    label: "ผิวขาวเหลือง",
    image: yellowSkin,
    desc: "ผิวขาวโทนเหลืองหรือเอเชีย ดูสว่างแต่ไม่ซีด"
  },
  {
    code: "medium",
    label: "ผิวสองสี",
    image: mediumSkin,
    desc: "ผิวกลาง ๆ ระหว่างขาวกับแทน โดนแดดแล้วผิวจะเข้มขึ้นง่าย"
  },
  {
    code: "tan",
    label: "ผิวแทน",
    image: tanSkin,
    desc: "ผิวสีน้ำผึ้งหรือแทน โทนอุ่น ดูสุขภาพดี"
  },
  {
    code: "deep",
    label: "ผิวเข้ม",
    image: deepSkin,
    desc: "ผิวสีน้ำตาลเข้มหรือช็อกโกแลต โทนลึก ชัด"
  }
];
...
export default function Step1Skintone() {
  ...
  return (
    <div className="container-page section">
      <h1 className="text-2xl font-bold mb-6">STEP 1/5 — สีผิว (Skintone)</h1>
