...
const OPTIONS = [
  { code: "dry",    label: "ริมฝีปากแห้ง/แตกเป็นขุย",  image: dryLipImg,   desc: "ริมฝีปากมีความแห้ง ลอก หรือแตกง่าย ลิปเนื้อแมตต์อาจทำให้เห็นร่องริมฝีปากชัด" },
  { code: "normal", label: "ริมฝีปากปกติ–ชุ่มชื้น",     image: moistLipImg, desc: "ริมฝีปากเรียบเนียน มีความชุ่มชื้น สามารถใช้ลิปได้หลายเนื้อสัมผัส" },
];
...
export default function Step3LipCondition() {
  ...
  return (
    <div className="container-page section">
      <span className="eyebrow">STEP 3/5</span>
      <h1 className="mt-3 font-display text-2xl sm:text-3xl font-semibold text-ink mb-6">สภาพริมฝีปาก</h1>
