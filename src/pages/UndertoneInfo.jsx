...
const CARDS = [
  {
    ...
    img: warmImg,
    bullets: [
      "เส้นเลือดที่ข้อมือออกเขียว",
      "เครื่องประดับทองมักขึ้น",
      "ออกแดดแล้วผิวเป็นสีแทนง่าย"
    ]
  },
  {
    code: "cool",
    ...
    img: coolImg,
    bullets: [
      "เส้นเลือดออกฟ้า/ม่วง",
      "เครื่องประดับเงิน/แพลตตินัมมักขึ้น",
      "ออกแดดแล้วอมชมพู/แดง"
    ]
  },
  {
    code: "neutral",
    ...
    img: neutralImg,
    bullets: [
      "มองเส้นเลือดออกทั้งเขียวและฟ้า",
      "ทอง/เงินใส่ได้พอ ๆ กัน",
      "ยืดหยุ่นต่อเฉดได้หลากหลาย"
    ]
  }
];
    ...
    <div className="container-page section">
      ...
      <div className="grid md:grid-cols-3 gap-4 mt-6">
        {CARDS.map((card) => (
          <div
            key={card.code}
            className="card p-5 rounded-2xl shadow hover:shadow-lg transition"
          >
            <img
              src={card.img}
              alt={card.code}
      ...
      <div className="mt-8 flex flex-wrap gap-3">
        <Link to="/quiz/step2-undertone" className="btn-primary">
          ไปเลือก Undertone
        </Link>

        <Link to="/quiz/step2-undertone" className="btn-ghost">
          ไม่แน่ใจ? เลือก Neutral ได้
        </Link>
      </div>
    </div>
  );
