...
const blankForm = { name: "", slug: "", logo_path: "" };
...
export default function BrandEditor() {
  ...
  function del() {
    ...
    setConfirmState({
      open: true,
      message: "ยืนยันลบแบรนด์นี้หรือไม่?",
      onConfirm: async () => {
  ...
  return (
    <div className="p-5 md:p-6">
      ...
      <form className="mt-5 grid grid-cols-1 gap-4 lg:grid-cols-[1fr_420px]" onSubmit={save}>
        ...
        <ImageUploader
          label="Brand logo"
          folder={`brands/${form.slug || "brand"}`}
          value={form.logo_path}
          onChangePath={(p) => set("logo_path", p)}
        />
      </form>
