// Centralized constants for recommendation scoring (Round 4)

export const depthPref = {
  fair: ["light", "medium"],
...
export const BASE_WEIGHTS = {
  ...
  depth_match: 0.28,
  durability: { 4: 0.08, 3: 0.05, 2: 0.02 },
};

// Occasion × depth (ฐานเดิม)
export const occDepthBias = {
...
export const COLOR_KEYWORDS = {
  ...
  pink: [
    /pink|rose|rosy|strawberry|mademoiselle|tokyo|istanbul|please me|pink veil|pink power/i,
  ],
  nude: [
    /nude|seductress|tiramisu|blush(?!\s*berry)|velvet teddy|bare it all|attitude|fenty glow/i,
  ],
...
export const OCCASION_COLOR_BIAS = {
  Party: {
    red: +0.28,
    berry: +0.22,
    fuchsia: +0.20,
